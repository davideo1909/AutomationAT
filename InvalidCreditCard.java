...
public class InvalidCreditCard {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        //Credit Card Number
        driver.findElement((By.xpath("//*[@id='mat-input-11']"))).sendKeys("0000000000000000");
        ...
        Thread.sleep(2000);
        //Validate that the error message is displayed with an invalid credit card
        Assert.assertTrue((driver.findElement(By.xpath("//mat-error[contains(text(),' Please enter a valid sixteen digit card number. ')]"))).isDisplayed());
